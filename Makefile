...
TARGETS = \
	...
	RnD-Linux-Test  \
	RnD \
	RnDEditor-Linux-Debug  \
	RnDEditor-Linux-DebugGame  \
	RnDEditor-Linux-Shipping  \
	RnDEditor-Linux-Test  \
	RnDEditor\
	configure
...
RnD-Linux-Debug:
	 $(PROJECTBUILD) RnD Linux Debug  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

RnD-Linux-DebugGame:
	 $(PROJECTBUILD) RnD Linux DebugGame  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

RnD-Linux-Shipping:
	 $(PROJECTBUILD) RnD Linux Shipping  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

RnD-Linux-Test:
	 $(PROJECTBUILD) RnD Linux Test  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

RnD:
	 $(PROJECTBUILD) RnD Linux Development  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

RnDEditor-Linux-Debug:
	 $(PROJECTBUILD) RnDEditor Linux Debug  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

RnDEditor-Linux-DebugGame:
	 $(PROJECTBUILD) RnDEditor Linux DebugGame  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

RnDEditor-Linux-Shipping:
	 $(PROJECTBUILD) RnDEditor Linux Shipping  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

RnDEditor-Linux-Test:
	 $(PROJECTBUILD) RnDEditor Linux Test  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

RnDEditor:
	 $(PROJECTBUILD) RnDEditor Linux Development  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)
